...
public class GreenFireBlock extends FireBlock {
    public GreenFireBlock() {
        super(FabricBlockSettings.of(Material.FIRE, MaterialColor.RED)
                .noCollision()
                .ticksRandomly()
                .breakInstantly()
                .lightLevel(15)
    ...
    public void onEntityCollision(BlockState blockState_1, World world_1, BlockPos blockPos_1, Entity entity_1) {
        entity_1.setOnFireFor(10);
        if (entity_1.isLiving()){
            ((LivingEntity) entity_1).addPotionEffect(new StatusEffectInstance(StatusEffects.POISON, 120, 220));
        }
    }
