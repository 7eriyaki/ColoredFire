...
public class FlintAndSteelRedItem extends Item {
    public FlintAndSteelRedItem(Settings item$Settings_1) {
    ...
    public ActionResult useOnBlock(ItemUsageContext itemUsageContext_1) {
        ...
        if (canIgnite(iWorld_1.getBlockState(blockPos_2), iWorld_1, blockPos_2)) {
            ...
            blockState_2 = ((RedFireBlock) ModContent.RED_FIRE_BLOCK).getStateForPosition(iWorld_1, blockPos_2);
